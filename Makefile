##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [2.29.1] date: [Sun Jun 17 16:28:27 BST 2018]
##########################################################################################################################
...
GCC_PATH = "$(CURDIR)/Tools/gcc-arm-none-eabi-7-2018-q2-update-win32/bin
JLINK = "JLink"
# The gcc compiler bin path can be either defined in make command via GCC_PATH variable (> make GCC_PATH=xxx)
# either it can be added to the PATH environment variable.
ifdef GCC_PATH
CC = $(GCC_PATH)/$(PREFIX)gcc" -pipe
...
flash:
	$(MAKE) all
	$(JLINK) -device STM32F100C8 -if SWD -speed 4000 -autoconnect 1 -CommanderScript JLinkCommandFile.jlink
